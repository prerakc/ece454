...
# How to run: 
# echo 50 | bash run_experiment.sh >& experiment_results_50_samples.txt
# echo 100 | bash run_experiment.sh >& experiment_results_100_samples.txt
...
echo "The number of samples to skip is $samples_to_skip"
